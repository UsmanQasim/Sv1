  ...
  return (
    <>
      <div className={style.section_3}>
        ...
        <p className={style.title_story}>Terms and Condition</p>
          ...
          <div>
            <ol>
              ...
              <li>
                ...
                relating to this website, including:
              </li>
              <ul>
                <li>Our the trademarks and logos;</li>
                <li>
                  The design, text, graphics and other content of the web pages
                  on this website, together with all the web addresses
                  associated with those web pages; and
                </li>
                <li>All the software used in relation to this website</li>
              </ul>
              <li>
                We are the owner or the authorised licensee of these
                intellectual property rights. You agree not to copy any content
                (including images) on this website without our consent.
              </li>

              <p className>
                <b>About the Conditions</b>
              </p>
              <li>
                If you access or use any part of this website you agree to these
                conditions. If you do not want to agree to these conditions, do
                not access or use this website
              </li>
              <li>
                We may change these conditions at any time without giving you
                notice. Please check these conditions from time to time for any
                changes. By continuing to use the website you agree to all the
                changes we make to these conditions.
              </li>
              <p>
                <b>Use of Website</b>
              </p>
              <li>
                We collect and use information in line with our Privacy Policy.
                By using this website, you agree to the way in which we collect
              ...
              <ul>
                <li>To send spam;</li>
                <li>
                  To harm, threaten, abuse or harass another person, or in a way
                  that invades someone's privacy or is (in our reasonable
                  opinion) offensive or is unacceptable or damaging to us, our
                  customers or suppliers;
                </li>
                <li>
                  To create, check, confirm, update or amend your own or someone
                  else's databases, records, directories, customer lists,
                  mailing or prospecting lists;
                </li>
                <li>
                ...
                <li>
                  ...
                  its content, or to interfere with or attempt to interfere with
                  how the website works.
                </li>
              </ul>
              <li>
                Catering Services" means the Catering Services set out in the
                Agreement together with any Additional Services to be provided
                to the Customer by Rhubarb under the terms of the Agreement.
              </li>
              <li>
              ...
              <li>
                ...
                by or on behalf of the Customer at the Premises on the Event
                Date.
              </li>
              <p>
                <b>Catering Terms and Conditions</b>
              </p>
              <li>
              ...
              <li>
                ...
                capable of acceptance, and is only valid for a period of 60
                Business Days from its date of issue.
              </li>
              <li>
                If the Customer wishes to modify an Order (including changes to
              ...
              <ul>
                <li>
                  ...
                  Plan in all material effects at the Premises on the Event
                  Date;
                </li>
                <li>
                ...
                <li>
                  ...
                  supplied (subject to reasonable prior consultation with the
                  Customer);
                </li>
                <li>
                  Providing staff as is required for the provision of the
                ...
                <li>
                  ...
                  following risks arising from the provision of the Catering
                  Services.
                </li>
              </ul>
              <li>
                Any rates, prices and discounts stated in catalogues, lists,
                mail shots, advertisements and other documents issued by Spice
                Village are subject to variation at any time without prior
                notice.
              </li>
              ...
              <ul>
                <li>
                  ...
                  Act 1979 and by section 2 of the Supply of Goods and Services
                  Act 1982 (title and quiet possession);
                </li>
                <li>
                  Breach of the terms implied by sections 13, 14 and 15 of the
                  Sale of Goods Act 1979 and sections 3, 4 and 5 of the Supply
                  of Goods and Services Act 1982 (description, satisfactory
              ...
              <li>
                ...
                and to protect any guest at an Event from possible injury or
                risk.
              </li>
              <li>
                Providing the Customer and its guests with access to Spice
                Village from the Start Time until the End Time and obtaining,
                and maintaining, all licences and consents required to provide
                the Services in accordance with all applicable laws and to host
                an Event in accordance with these Terms and Conditions.
              </li>
              <li>The Customer's Obligations</li>
              ...
              <li>
                Pay the Price in accordance with these Terms and Conditions.
              </li>
              ...
              <li>
                Event Management may be provided in addition to the provision of
                the Services. The cost of Event Management is dependent on the
                requirements for each Event. Such costs shall be itemised and
              ...
              <p>
                ...
                matter arising out of or connected with the Agreement.
              </p>
            </ol>
          </div>
        </div>
